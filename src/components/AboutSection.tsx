        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16">
          ...
          >
            <div className="relative">
              <img
                src={headshot}
                alt="Dave Sonntag, CEO of Decibel Events, professional headshot"
          ...
          <motion.div
            ...
            className="md:w-[60%]"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-2">About Dave</h2>
            <SectionHeadingAccent />
            <div className="mb-8" />

            <div className="space-y-6 text-base leading-[1.7] text-muted-foreground">
              <p>
                Dave Sonntag has spent over two decades producing high-stakes live events for federal agencies, Fortune 500 corporations, and national associations. As CEO and Founder of <DecibelLink>Decibel Events</DecibelLink> — a Washington, DC-based event production firm continuously ranked on the Washington Business Journal's Largest Meeting & Event Planners list since 2019 — his work spans the Library of Congress National Book Festival, Department of Defense trade shows, presidential campaign events, and Fortune 500 leadership conferences.
              </p>
              <p>
                Before founding <DecibelLink>Decibel Events</DecibelLink>, Dave served as Vice President at FleishmanHillard, where he produced multi-million-dollar programs for the Library of Congress, AARP, and the Social Security Administration. He served as Lead Site Advance for the 2008 Presidential Campaign and as Personal Aide to Senator Fred Thompson during his presidential run — experiences that built the operational rigor and zero-margin-for-error standard that define Decibel's approach today.
              </p>
              <p>
                11 Telly Awards, including two Gold, for the Library of Congress National Book Festival. Nine PRSA Silver Anvil honors spanning 2006 to 2017. An Event Technology Award for experiential work. Dave also produced the 70-day AARP Voices of Civil Rights bus tour, which built the nation's largest oral history archive of the civil rights movement, now housed at the Library of Congress; the resulting History Channel documentary won a Peabody Award and a News &amp; Documentary Emmy for Outstanding Research. Additional campaign recognition includes PRWeek and PR Daily awards for DoubleTree by Hilton's Cookie CAREavan. Continuously ranked on the Washington Business Journal's largest event companies list since 2019, #17 in 2026. Triangle Business Journal 40 Under 40.
              </p>
              <p>
                Dave holds a BA in Economics from Wake Forest University and a Marketing Advantage Certificate from Georgetown University. He was named to Triangle Business Journal's 40 Under 40 and is a founding investor in the Triangle Tweener Fund. He is available for podcast appearances, industry speaking engagements, and mentorship conversations.
              </p>
            </div>
          </motion.div>
        </div>
