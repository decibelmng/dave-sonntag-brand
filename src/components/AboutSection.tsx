        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16">
          ...
          >
            ...
            <div className="space-y-6 text-base leading-[1.7] text-muted-foreground">
              ...
              <p>
                Before founding <DecibelLink>Decibel Events</DecibelLink>, Dave served as Vice President at FleishmanHillard, where he produced multi-million-dollar programs for the Library of Congress, AARP, and the Social Security Administration. Dave produced the 70-day AARP Voices of Civil Rights bus tour, which built the nation's largest oral history archive of the civil rights movement, now housed at the Library of Congress. The resulting History Channel documentary won a Peabody Award and a News &amp; Documentary Emmy for Outstanding Research. He served as Lead Site Advance for the 2008 Presidential Campaign and as Personal Aide to Senator Fred Thompson during his presidential run — experiences that built the operational rigor and zero-margin-for-error standard that define Decibel's approach today.
              </p>
              <p>
