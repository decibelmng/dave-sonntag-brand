  ...
  return (
    ...
    >
      ...
      <div
        ...
        role="img"
        aria-label="Dave Sonntag producing a live event at a production desk with headset"
      />
      {/* Dark overlay */}
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          >
            ...
            <a
              href="#contact"
              className="inline-block px-8 py-3 rounded-sm border border-foreground text-foreground font-semibold text-sm tracking-wide uppercase hover:bg-foreground hover:text-background transition-colors duration-300"
            >
              Get in Touch
            </a>
          </motion.div>
